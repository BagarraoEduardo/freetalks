...
public class ImageMessage extends Message{
	...
	public ImageMessage(JSONObject obj) throws Exception {
		...
		if(obj.has(KEY_SENDER) &&
			...
			throw new IllegalArgumentException("[" + KEY_SENDER + "],[" + KEY_DATE + "],[" + KEY_TOPIC + "],[" + KEY_IMAGE + 
